...
str1=(ospf_route_list[0])
str2=(ospf_route_list[1]).strip('[]')
str3=(ospf_route_list[3]).strip(',')
str4=(ospf_route_list[4]).strip(',')
str5=(ospf_route_list[5])
template = """
Prefix                {}
AD/Metric             {}
Next-Hop              {}
...
Outbound Interface    {}
"""
print(template.format(str1,str2,str3,str4,str5))